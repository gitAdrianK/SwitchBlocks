...
{
    public class BehaviourSequenceIceC : IBlockBehaviour
    {
        ...
        public bool ExecuteBlockBehaviour(BehaviourContext behaviourContext)
        {
            ...
            IsPlayerOnBlock = advCollisionInfo.IsCollidingWith<BlockSequenceIceC>();
            ...
            List<IBlock> blocks = advCollisionInfo.GetCollidedBlocks().ToList().FindAll(b => b.GetType() == typeof(BlockSequenceIceC));
