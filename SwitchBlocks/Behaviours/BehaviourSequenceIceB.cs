...
{
    public class BehaviourSequenceIceB : IBlockBehaviour
    {
        ...
        public bool ExecuteBlockBehaviour(BehaviourContext behaviourContext)
        {
            ...
            IsPlayerOnBlock = advCollisionInfo.IsCollidingWith<BlockSequenceIceB>();
            ...
            List<IBlock> blocks = advCollisionInfo.GetCollidedBlocks().ToList().FindAll(b => b.GetType() == typeof(BlockSequenceIceB));
