namespace SwitchBlocks.Patches
{
    ...
    /// </summary>
    [HarmonyPatch(typeof(BodyComp), "IsOnBlock", new Type[] { typeof(Type) })]
    public class PatchBodyComp
    {
        /// <summary>
        /// Patches the IsOnBlock method of the <see cref="BodyComp"/>, adds the custom blocks from this mod to also return <c>true</c>
        /// in the IsOnBlock function when asked if the <see cref="BodyComp"/> is on a custom block imitating the vanilla blocks behaviour.
        /// </summary>
